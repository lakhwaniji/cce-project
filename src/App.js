        ...
        <div>
          ...
          <Router>
            <Routes>
              ...
              />
              <Route
                path="/upload_stu_data"
                element={<UploadStuData user={{ user }} />}
              />
              <Route
                path="/upload_fac_data"
                element={<UploadFacData user_email={user.email} />}
              />
              <Route
                path="/create_user"
                element={<UserCreation user_role={user.role} />}
              />
            </Routes>
          </Router>
        </div>
